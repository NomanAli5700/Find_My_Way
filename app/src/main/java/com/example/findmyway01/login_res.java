...
public class login_res extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pass6=findViewById(R.id.username);
        ...
        reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it=new Intent(login_res.this,sign_res.class);
                startActivity(it);
            }
        });
        ...
        BiometricPrompt biometricPrompt = new BiometricPrompt(login_res.this,
            ...
            public void onAuthenticationSucceeded(
                ...
                startActivity(new Intent(login_res.this, map.class));
            }
    ...
    private void Login(){
        ...
        String Pass_1 = pass6.getText().toString().trim();
                            ...
                            if (task.isSuccessful()) {
                                ...
                                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@Nonnull DataSnapshot snapshot) {
                                        if (snapshot.exists() && snapshot.getValue().toString().equalsIgnoreCase("rescue_admin")) {
                                            // User is an admin, navigate to admin activity
                                            startActivity(new Intent(login_res.this, admin_panel.class));
                                        } else {
                                ...
                                Toast.makeText(login_res.this, "Email or password is incorrect!", Toast.LENGTH_LONG).show();
                            }
                        }
                    });
        } else {
            Toast.makeText(login_res.this, "Something went wrong!", Toast.LENGTH_LONG).show();
        }
    }
    ...
    void checkBioMetricSupported()
    {
        ...
        Toast.makeText(login_res.this,info,Toast.LENGTH_SHORT).show();

...
public class map extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        public void onMapReady(GoogleMap googleMap) {
           ...
           // 73.49112719999999, 32.5824296
            mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(mandiBahauddin, 12.0f)); // Adjust the zoom level as needed

        if (isRescueOrganizationUser()) {
    ...
    private boolean isRescueOrganizationUser() {
    ...
    private void fetchAndDisplayAlertsFromFirebase() {
        databaseReference.child("emergencies").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                Toast.makeText(map.this, "Failed to fetch data from Firebase", Toast.LENGTH_SHORT).show();
            }
        });
    }

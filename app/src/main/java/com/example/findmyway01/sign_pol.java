...
public class sign_pol extends AppCompatActivity {
    public EditText fname,lname,email,org,des,contact_no,pass,cpass,year,month,day,district,city;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sign_pol);
        ...
        email=findViewById(R.id.emp4);
        des=findViewById(R.id.des4);
        org=findViewById(R.id.org2);
        pass=findViewById(R.id.pass4);
        contact_no=findViewById(R.id.cn4);
        cpass=findViewById(R.id.cpass4);
        year=findViewById(R.id.yy4);
        month=findViewById(R.id.mm4);
        day=findViewById(R.id.dd4);
        district=findViewById(R.id.dis4);
        city=findViewById(R.id.city4);
        sign_up=findViewById(R.id.up4);
                        ...
                        .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@Nonnull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()) {
                                        ...
                                        mDatabaseRef.child(userId).setValue(user)
                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@Nonnull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            Toast.makeText(sign_pol.this, "Registered Successfully", Toast.LENGTH_SHORT).show();
                                                            Intent it=new Intent(sign_pol.this,login_pol.class);
                                                            startActivity(it);
                                                        } else {
                                                            Toast.makeText(sign_pol.this, "Failed to register, please try again!", Toast.LENGTH_LONG).show();
                                                        }
                                                    }
                                                });
                                    }
                                    ...
                                    Toast.makeText(sign_pol.this, "Failed to register, please try again! " + task.getException(), Toast.LENGTH_LONG).show();
                                }
                            }
                        });
            }
